...
const DOWNLOAD_URL =
  'https://github.com/Reynbow/showmeskins/releases/latest/download/Show.Me.Skins.Companion.Setup.0.3.0.exe';
    ...
    <div className="companion-page">
      ...
      <div className="companion-content">
        ...
        <div className="companion-download-section">
          ...
          <span className="companion-version">v0.3 Beta &middot; Windows 10/11</span>
